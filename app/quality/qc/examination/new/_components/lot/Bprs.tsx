...
const Bprs = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      <SectionTitle>Latest Batches</SectionTitle>
          ...
          {latest.map(l => {
            return (
              ...
              >
                ...
                <h1 className="font-poppins text-md font-medium">BPR #{l.batchNumber}</h1>
