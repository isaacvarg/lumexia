...
import { createRequestNoteType } from "../../[referenceCode]/_functions/createRequestNoteType"
...
const CreateNoteTypeForm = ({ setMode,  }: { setMode: Dispatch<SetStateAction<'addNoteType' | 'default' | 'show'>>, }) => {
    ...
    const handleSubmit = async (values: Inputs) => {
        await createRequestNoteType(values);
